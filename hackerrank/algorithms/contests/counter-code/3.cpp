...
int main()
{
	TC(){
        	...
        	if(m<n)
		{
			...
			{
               	  		m=m%n;
                		cout << (n+1-m/2) << " " << matter << endl;
            		}
            		else
			{
                		m=m%n;
                		cout << ((m+1)/2) << " " << matter << endl;
            		}
        	}
        	else if(n%2==1)
		{
         		if(m%n==0)
                		cout << (n+1)/2 << " " << matter << endl; 
           		else if((m/n)%2==0)
			{
                  		if(m%2==0)
                    		{
            		...
            		else
			{
				...
				{
                     			m=m%n;
                    			cout << (n+1-(m+1)/2) << " " << matter << endl;
                		}
                		else
				{
                     			m=m%n;
                    			cout << (m/2) << " " << matter << endl;
                		}
            		}
        	}
        	else
		{
			...
			{
                 		m=m%n;
                		if(m==0) cout << ((n+2)/2) << " " << matter << endl;
                		else cout << (n+1-m/2) << " " << matter << endl;
            		} 
           		else
                	{
                		if(m%n==0)
